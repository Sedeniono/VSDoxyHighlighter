  ...
  public class CommentFormatterTests
  {
    ...
    public void VariousKeywordsShouldBeFormatted()
    {
      ...
      var expectedTextFragments = new List<Utils.FormattedFragmentText>() {
        ...
        new Utils.FormattedFragmentText(@"class.h", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\class", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"Test3::MemClass", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\class", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"Test4", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\class", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"Test5", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\class", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"\class", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"\class", FormatTypes.NormalKeyword),
        ...
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"Class1", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"Class2", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"Class3", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"match", FormatTypes.Parameter),
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
        new Utils.FormattedFragmentText(@"\ref", FormatTypes.NormalKeyword),
