  ...
  public class CommentFormatterTests
  {
    ...
    List<Utils.FormattedFragmentText> GetExpectedTextFragmentsForVariousKeywordsTests()
    {
      var expectedTextFragments = new List<Utils.FormattedFragmentText>() {
        ...
        new Utils.FormattedFragmentText(@"\qualifier", FormatType.Command),
        new Utils.FormattedFragmentText(@"quali", FormatType.Parameter1),
        new Utils.FormattedFragmentText(@"\qualifier", FormatType.Command),
        new Utils.FormattedFragmentText(@"""SOMEQUALI text""", FormatType.Parameter1),
        new Utils.FormattedFragmentText(@"\qualifier", FormatType.Command),
        new Utils.FormattedFragmentText(@"""Another""", FormatType.Parameter1),
        new Utils.FormattedFragmentText(@"\qualifier", FormatType.Command),
        new Utils.FormattedFragmentText(@"""yet""", FormatType.Parameter1),
        new Utils.FormattedFragmentText(@"\qualifier", FormatType.Command),
        new Utils.FormattedFragmentText(@"""more text""", FormatType.Parameter1),
        new Utils.FormattedFragmentText(@"\qualifier", FormatType.Command),
