  ...
  public class CommentParserTests
  {
    ...
    List<Utils.FormattedFragmentText> GetExpectedTextFragmentsForVariousKeywordsTests()
    {
      var expectedTextFragments = new List<Utils.FormattedFragmentText>() {
        ...
        new Utils.FormattedFragmentText(@"include_test.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\include{lineno}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"some dir\include_test.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\include{doc}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"""some dir\include_test.cpp""", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\include{local}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"""some dir\include_test.cpp""", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\include{lineno,local}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"include_test.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\include{doc,local}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"include_test.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\include{local,lineno}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"include_test.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\include{local,doc}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"include_test.cpp", ClassificationEnum.Parameter1),
        ...
        new Utils.FormattedFragmentText(@"\snippet{lineno}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"snippets/example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{doc}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{trimleft}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{local}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{lineno,local}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{doc,local}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{trimleft,local}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{local,lineno}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{local,doc}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
        new Utils.FormattedFragmentText(@"\snippet{local,trimleft}", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"example.cpp", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"resource", ClassificationEnum.Title),
