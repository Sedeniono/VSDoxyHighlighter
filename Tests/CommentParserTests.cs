  ...
  public class CommentParserTests
  {
    ...
    List<Utils.FormattedFragmentText> GetExpectedTextFragmentsForVariousKeywordsTests()
    {
      var expectedTextFragments = new List<Utils.FormattedFragmentText>() {
        ...
        new Utils.FormattedFragmentText(@"\inheritancegraph", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{no}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"@inheritancegraph", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{  YES  }", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\inheritancegraph", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{text}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\inheritancegraph", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{GRAPH }", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\inheritancegraph", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{ Builtin}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\inheritancegraph", ClassificationEnum.Command),
        ...
        new Utils.FormattedFragmentText(@"[ out, in]", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\param", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"[outin]", ClassificationEnum.ParameterClamped),
        ...
        new Utils.FormattedFragmentText(@"--", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\param", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"1", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\param", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"[out]", ClassificationEnum.ParameterClamped),
        ...
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{html}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{latex:1}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{XML: 6}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{xml , html : 2 , latex,docbook:3}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{ XML }", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\tableofcontents", ClassificationEnum.Command),
        ...
        new Utils.FormattedFragmentText(@"{.py}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{.c}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{.py}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{.cpp}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{.c++}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{.unparsed}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{.CS}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\endcode", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\code", ClassificationEnum.Command),
        ...
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"docbook", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"""width/height must be lower case""", ClassificationEnum.Parameter2),
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{inline,anchor:id}", ClassificationEnum.ParameterClamped),
        ...
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{ INLINE  }", ClassificationEnum.ParameterClamped),
        ...
        new Utils.FormattedFragmentText(@"height=1cm", ClassificationEnum.Parameter1),
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"{Anchor: some id, inline}", ClassificationEnum.ParameterClamped),
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
        new Utils.FormattedFragmentText(@"\image", ClassificationEnum.Command),
