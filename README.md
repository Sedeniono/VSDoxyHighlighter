...
Only Visual Studio 2022 and 2026 are supported. Earlier versions are not supported.
...
- [All commands](https://www.doxygen.nl/manual/commands.html) of Doxygen 1.17.0 are supported.
