...
namespace VSDoxyHighlighter
{
  ...
  public class DefaultColors : IDisposable
  {
    ...
    static readonly Dictionary<string, TextProperties> cLightColors = new Dictionary<string, TextProperties> {
      ...
      { ClassificationIDs.ID_parameterClamped,           new TextProperties(foreground: Color.FromRgb(14, 85, 156),   background: null, isBold: false, isItalic: false) },
      ...
      { ClassificationIDs.ID_exceptions,                 new TextProperties(foreground: Color.FromRgb(190, 120, 169), background: null, isBold: true,  isItalic: false) },
      { ClassificationIDs.ID_emphasisMinor,              new TextProperties(foreground: Color.FromRgb(0, 75, 0),      background: null, isBold: false, isItalic: true) },
      ...
      { ClassificationIDs.ID_emphasisHuge,               new TextProperties(foreground: Color.FromRgb(0, 75, 0),      background: null, isBold: true,  isItalic: true) },
      { ClassificationIDs.ID_strikethrough,              new TextProperties(foreground: null,                         background: null, isBold: false, isItalic: false) },
      { ClassificationIDs.ID_strikethroughEmphasisMinor, new TextProperties(foreground: Color.FromRgb(0, 75, 0),      background: null, isBold: false, isItalic: true) },
      { ClassificationIDs.ID_strikethroughEmphasisMajor, new TextProperties(foreground: Color.FromRgb(0, 75, 0),      background: null, isBold: true,  isItalic: false) },
      { ClassificationIDs.ID_strikethroughEmphasisHuge,  new TextProperties(foreground: Color.FromRgb(0, 75, 0),      background: null, isBold: true,  isItalic: true) },
    ...
    static readonly Dictionary<string, TextProperties> cDarkColors = new Dictionary<string, TextProperties> {
      ...
      { ClassificationIDs.ID_parameterClamped,           new TextProperties(foreground: Color.FromRgb(152, 207, 223), background: null, isBold: false, isItalic: false) },
      ...
      { ClassificationIDs.ID_warningKeyword,             new TextProperties(foreground: Color.FromRgb(255, 36, 23),   background: null, isBold: true,  isItalic: false) },
      { ClassificationIDs.ID_noteKeyword,                new TextProperties(foreground: Color.FromRgb(255, 155, 0),   background: null, isBold: true,  isItalic: false) },
      { ClassificationIDs.ID_exceptions,                 new TextProperties(foreground: Color.FromRgb(202, 145, 186), background: null, isBold: true,  isItalic: false) },
      { ClassificationIDs.ID_emphasisMinor,              new TextProperties(foreground: Color.FromRgb(140, 203, 128), background: null, isBold: false, isItalic: true) },
      ...
      { ClassificationIDs.ID_emphasisHuge,               new TextProperties(foreground: Color.FromRgb(166, 215, 157), background: null, isBold: true,  isItalic: true) },
      { ClassificationIDs.ID_strikethrough,              new TextProperties(foreground: null,                         background: null, isBold: false, isItalic: false) },
      { ClassificationIDs.ID_strikethroughEmphasisMinor, new TextProperties(foreground: Color.FromRgb(140, 203, 128), background: null, isBold: false, isItalic: true) },
      { ClassificationIDs.ID_strikethroughEmphasisMajor, new TextProperties(foreground: Color.FromRgb(166, 215, 157), background: null, isBold: true,  isItalic: false) },
      { ClassificationIDs.ID_strikethroughEmphasisHuge,  new TextProperties(foreground: Color.FromRgb(166, 215, 157), background: null, isBold: true,  isItalic: true) },
